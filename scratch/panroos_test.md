...
cd 07-ads_expression/vince_trees/panaroo_test
mkdir gff_files
cd gff_files
awk '{print $1}' ../../../arcGene_read_counts.cleaned.txt | sed 's/_.*//' | sort | uniq | while read line; do grep $line ../../../homd_map/annotations_marge.tsv; done > ads_annotations.tsv
