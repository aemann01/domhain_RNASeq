...
#SBATCH --job-name denovoMap-DM00517V2PQ36
#SBATCH --nodes 1
...
STAR --runThreadN 40 \
   ...
   --outFileNamePrefix /scratch/amann3/filtered/DM00517V2PQ36.denovo \
   --outSAMtype BAM Unsorted \
   --outReadsUnmapped /scratch/amann3/filtered/DM00517V2PQ36.denovo.unmapped.bam \
