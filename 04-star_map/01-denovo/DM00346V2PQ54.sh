...
#SBATCH --job-name denovoMap-DM00346V2PQ54
#SBATCH --nodes 1
...
STAR --runThreadN 40 \
   ...
   --outFileNamePrefix /scratch/amann3/filtered/DM00346V2PQ54.denovo \
   --outSAMtype BAM Unsorted \
   --outReadsUnmapped /scratch/amann3/filtered/DM00346V2PQ54.denovo.unmapped.bam \
