...
#SBATCH --job-name denovoMap-DM00428V2PQ84
#SBATCH --nodes 1
...
STAR --runThreadN 40 \
   ...
   --outFileNamePrefix /scratch/amann3/filtered/DM00428V2PQ84.denovo \
   --outSAMtype BAM Unsorted \
   --outReadsUnmapped /scratch/amann3/filtered/DM00428V2PQ84.denovo.unmapped.bam \
