...
```sh
cd ~/rna_dohmain/filtered
STAR --runThreadN 40 \
   --genomeDir ~/rna_dohmain/11-perio/05-TrEMBL/GenomeDir \
   --readFilesIn <(gunzip -c DM00437V2PQ26.1.fastq.gz) <(gunzip -c DM00437V2PQ26.2.fastq.gz) \
   --outFileNamePrefix ~/rna_dohmain/red-mapping/DM00437V2PQ26.red \
   --outSAMtype BAM Unsorted \
   --outReadsUnmapped ~/rna_dohmain/red-mapping/DM00437V2PQ26.red.unmapped.bam \
   --quantMode TranscriptomeSAM GeneCounts \
   --alignIntronMax 1 \
   --chimOutType SeparateSAMold
```
