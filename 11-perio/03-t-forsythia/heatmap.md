...
summary(res)
# [1] "number of genes with adjusted p value lower than 0.05:  1817"
# out of 11458 with nonzero total read count
# adjusted p-value < 0.05
# LFC > 0 (up)       : 994, 8.7%
# LFC < 0 (down)     : 823, 7.2%
# outliers [1]       : 0, 0%
# low counts [2]     : 2664, 23%
# (mean count < 1)
```
```R
library(reshape2)
...
save_pheatmap_pdf(x, "heatmap.test.tforsythia.pdf")
system("~/.iterm2/imgcat ./heatmap.test.tforsythia.pdf")
```
By top gene
```R
library(tidyr)
