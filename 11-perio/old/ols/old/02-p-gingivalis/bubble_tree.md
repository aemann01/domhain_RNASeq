...
summary(res)
# [1] "number of genes with adjusted p value lower than 0.05:  2166"
# out of 74749 with nonzero total read count
# adjusted p-value < 0.05
# LFC > 0 (up)       : 2145, 2.9%
# LFC < 0 (down)     : 21, 0.028%
# outliers [1]       : 0, 0%
# low counts [2]     : 57407, 77%
# (mean count < 1)
```
```R
library(reshape2)
...
save_pheatmap_pdf(x, "heatmap.test.pging.pdf")
system("~/.iterm2/imgcat ./heatmap.test.pging.pdf")
```
By top gene
```R
library(tidyr)
